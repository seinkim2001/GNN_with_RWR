...
# ✅ attribute 벡터 경로 지정
attr_dir = "./attributes/generated"  # 또는 ./attributes/combined
...
df.to_csv("./results/link_prediction_results_with_gate_modi_1.csv", index=False)
print("✅ 모든 실험 완료! 결과는 ./results/link_prediction_results_with_gate_modi_1.csv 에 저장됨.")
