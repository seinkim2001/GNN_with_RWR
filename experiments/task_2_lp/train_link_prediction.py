...
# # ✅ 디코더 (dot product + sigmoid)
# def decode(z, edge_index):
#     dot_product = (z[edge_index[0]] * z[edge_index[1]]).sum(dim=1)
...
attr_dir = "./attributes/generated_50_cora"  # Cora - random sampling 전용
# attr_dir = "./attributes/random_avg_citeseer"  # Cora - random sampling 전용
# attr_dir = "./attributes/generated_extended_similarity"  # Cora - random sampling 전용
