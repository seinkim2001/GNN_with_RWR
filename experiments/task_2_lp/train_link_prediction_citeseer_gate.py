...
print(f"총 {len(files)}개의 속성 벡터에 대해 Citeseer + Gate 실험 시작...")
...
df.to_csv("./results/link_prediction_results_with_gate_citeseer.csv", index=False)
print("✅ 모든 Citeseer + Gate 실험 완료! 결과는 ./results/link_prediction_results_with_gate_citeseer.csv 에 저장됨.")
